...
# license     : gplv3
# modified by : Harry DS Alsyundawy
...
adListSource="https://raw.githubusercontent.com/alsyundawy/hds-pihole-blacklist/master/adlists.list.updater"
...
if [ $update -eq 1 ] ; then
  ...
  apt update; apt dist-upgrade -y; apt dist-upgrade -y; apt install git curl screen htop iftop rsync dnsutils net-tools -y
